...
class _NotificationScreenState extends State<NotificationScreen> {
  ...
  void initState() {
    super.initState();
    ApiController.getAllNotifications().then((value) {
      setState(() {
        isLoadingApi = false;
                    ...
                    Flexible(
                        child: Container(
                            ...
                            child: ListView.builder(
                              itemBuilder: (context, index) => _makeCard(index),
  ...
  _makeCard(int index) {
    ...
    return InkWell(
                    ...
                    Row(
                      ...
                      children: <Widget>[
                        Padding(
                          ...
                          child: Text(Utils.convertNotificationDateTime(resposneModel.data[index].created),
                              style:
                        ...
                        Padding(
                            ...
                            child: Text(Utils.convertNotificationDateTime(resposneModel.data[index].created,onlyTime: true),
                                style: TextStyle(
      ...
      onTap: (){
       if(resposneModel.data[index].type.toLowerCase().compareTo('order')==0){
         Navigator.push(
           context,
