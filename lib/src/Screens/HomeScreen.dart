...
class _StoreListWithSearch extends State<HomeScreenUI> {
          ...
          children: <Widget>[
            ...
            Expanded(
              child: FutureBuilder<List<CategoriesData>>(
                  future:
                      ApiController.getCategoriesApiRequest(storeData.store.id),
                      ...
                      if (projectSnap.hasData) {
                        ...
                        return Container(
                          ...
                          child: GridView.count(
                              ...
                              shrinkWrap: true,
                              children: projectSnap.data
                                  .map((CategoriesData categoriesData) {
                                return GridTile(
                                    child: CategoriesView(categoriesData));
                              }).toList()),
                        );
          ...
          children: <Widget>[
            ...
            ListTile(
              ...
              onTap: () {
                ...
                Navigator.push(
                  context,
                  MaterialPageRoute(
                      builder: (context) => MyOrderScreen(context)),
                );
              },
            ),
            ListTile(
              ...
              onTap: () {
                ...
                Navigator.push(
                  context,
                  MaterialPageRoute(
                      builder: (context) => BookNowScreen(context)),
                );
            ...
            ListTile(
              ...
              onTap: () {
                ...
                Navigator.push(
                  context,
                  // MaterialPageRoute(builder: (context) => Du(context)),
  ...
  _handleDrawer() async {
    ...
    setState(() {
      ///DO MY Logic CALLS
      _counter++;
      appLink = prefs.getString(AppConstant.AndroidShareLink);
      ...
      preferences.clear().then((status) {
        if (status == true) {
          ...
          SharedPrefs.storeSharedValue(
              AppConstant.STORE_ID, storeData.store.id);
  ...
  Future<void> share() async {
    await FlutterShare.share(
      ...
      */
        ...
        text: 'Kindly download' + storeData.store.storeName + 'app from',
        linkUrl: appLink,
