...
DeliveryTimeSlotModel deliveryTimeSlotModelFromJson(String str) => DeliveryTimeSlotModel.fromJson(json.decode(str));

String deliveryTimeSlotModelToJson(DeliveryTimeSlotModel data) => json.encode(data.toJson());
...
class Data {
  ...
  factory Data.fromJson(Map<String, dynamic> json) => Data(
    ...
    dateTimeCollection: List<DateTimeCollection>.from(json["date_time_collection"].map((x) => DateTimeCollection.fromJson(x))),
  );

  Map<String, dynamic> toJson() => {
    "is24x7_open": is24X7Open,
    "date_time_collection": List<dynamic>.from(dateTimeCollection.map((x) => x.toJson())),
  };
}
